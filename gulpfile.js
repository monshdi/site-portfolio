...
let paths = {
	...
	deploy: {
		hostname: 'banditff@isp1.ru.fastfox.pro', // Deploy hostname
		destination: 'www/monshdi.ru/', // Deploy destination
		include: [/* '*.htaccess' */], // Included files to deploy
		exclude: ['**/Thumbs.db', '**/*.DS_Store', 'sass', 'scss', 'styl', 'less', 'ht.acces'], // Excluded files from deploy
	},
